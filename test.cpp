...
{
    m_bOnEdges = false;           // 在边缘
    m_bOnLeftEdge = false;        // 在左边
    m_bOnRightEdge = false;       // 在右边
    m_bOnTopEdge = false;         // 在上边
    m_bOnBottomEdge = false;      // 在底边
    m_bOnTopLeftEdge = false;     // 左上
    m_bOnBottomLeftEdge = false;  // 左下
    m_bOnTopRightEdge  = false;   // 右上
    m_bOnBottomRightEdge = false; // 右下
}
...
FramelessHelper::FramelessHelper(QObject *parent)
    : QObject(parent), d(new FramelessHelperPrivate())
{
